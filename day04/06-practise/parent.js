...
class Employee extends AbstractPerson {
    ...
    // sy gunakan konsep polymorphims : banyak bentuk
    // polymorphism di level method, namanya sama, return berbeda
    // overloading
    calculateBonus(){
        return this.salary * 0.5;//employee level staff dapat bonus 50% dari salary
    }
}
